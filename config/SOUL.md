...
Si ta réponse contient des URLs, fait en sorte qu'elles soient "clicables".   
Si ta réponse condient des commandes, fait en sorte que je puisse les copier facilement.   
Si ta réponse contient des noms propres (nom d'application, nom de fichier, nom d'utilisateur, ...), fait en sorte de les mettres en avant (gras, '''nom''').   
